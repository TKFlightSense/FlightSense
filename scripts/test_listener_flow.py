...
def test_flow():
    ...
    test_review = "The cabin crew was excellent, very attentive. However, the meal was cold and tasteless."
    flight_num = "TEST-999"
    ...
    try:
        ...
        cursor.execute("SELECT * FROM processed_reviews WHERE review_id = %s", (review_id,))
        ...
        if segments:
            ...
            for seg in segments:
                print(f"      - Label: {seg['label']:<30} | Sentiment: {seg['sentiment']:<10} | Priority: {seg['priority']}")
        else:
