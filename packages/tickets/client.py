...
class TicketPayload:
    ...
    department: str
    primary_label: str
    priority: str = "Medium"  # Jira priority: Highest, High, Medium, Low, Lowest
    labels: list = None  # Jira labels
...
class RealJiraTicketClient(AbstractTicketClient):
    ...
    def create_issue(self, payload: TicketPayload) -> Dict[str, Any]:
        ...
        """
        try:
            # Build extra fields for labels
            extra_fields = {}
            if payload.labels:
                extra_fields["labels"] = payload.labels
            
            # Create issue in Jira with priority and labels
